<template>
  ...
  <div class="
        ...
        <!-- 中间分隔线 -->
        <div class="lg:ml-6 lg:h-full block border border-[rgba(153,151,151,1)] bg-[rgba(153,151,151,1)]"></div>
        <div class="lg:ml-6 lg:w-[300px]  text-center pt-4">请选择支付方式
            <!-- 使用v-for循环进行生成，在const payWay那里 -->
            <div v-for="i in payWay">
                <button class="border lg:h-16 lg:w-48 mt-4 rounded-lg border-[#C7BBBB] bg-[rgba(143,135,135,0.28)]
